  ...
  BinomialExtensionField<F, D>: ExtensionField<F>,
{
  ...
  fn from(expr: SymbolicExpression<F>) -> Self {
    match expr {
      SymbolicExpression::Variable(v) => Self::Variable(SymbolicVariable::new(v.entry, v.index)),
...
mod tests {
  ...
  fn test_symbolic_expression_degree_multiple() {
    ...
    let preprocessed_var =
      SymbolicExpression::Variable(SymbolicVariable::new(Entry::Preprocessed { offset: 0 }, 2));
    assert_eq!(
  ...
  fn test_degree_multiple_for_addition() {
    let a =
      SymbolicExpression::Variable::<BabyBear>(SymbolicVariable::new(Entry::Main { offset: 0 }, 1));
    let b =
      SymbolicExpression::Variable::<BabyBear>(SymbolicVariable::new(Entry::Main { offset: 0 }, 2));
    let result = a + b;
    match result {
      SymbolicExpression::Add {
        degree_multiple,
  ...
  fn test_subtraction_creates_sub_node() {
    ...
    let a =
      SymbolicExpression::Variable::<BabyBear>(SymbolicVariable::new(Entry::Main { offset: 0 }, 0));
    let b =
      SymbolicExpression::Variable::<BabyBear>(SymbolicVariable::new(Entry::Main { offset: 0 }, 1));
